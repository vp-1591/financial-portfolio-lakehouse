...
> **Superseded by [ADR 0018](./0018-bitwarden-secrets-and-config.md)** — ADR 0011 standardized `--t212-*` CLI flags; ADR 0018 removed broker CLI flags entirely in favor of YAML config (later replaced by env vars in ADR 0020).
